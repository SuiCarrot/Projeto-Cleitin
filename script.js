...
const monstros = [
  ...
  },
  {
    ...
    defesa: 2,
    dano: [
      { nome: "espada enferrujada", dano: 9 },
      { nome: "pancada com escudo", dano: 6 },
    ],
    rota: "montanhas",
  },
  {
  ...
  },
  {
    ...
    dano: [
      ...
      { nome: "mísseis mágicos", dano: random(10, 13) },
    ],
    rota: `aerin`,
  },
];
      ...
      //Objeto para calcular e aplicar no combate um ataque especial que causa mais dano
      {
        ...
        danoADD: () => {
          ...
          personagens.jogador.ataque[0].dano =
            personagens.jogador.equip[0].dano + 5;
        },
      },
    ],
    funcoes: [
...
function mortalKombat(qtd, rota) {
  for (let i = 0; i < qtd; i++) {
    ...
    while (
      ...
      console.log(
        `\x1b[31m${monstroLUTA[escolherMONSTRO].nome}\x1b[0m usou \x1b[31m${monstroLUTA[escolherMONSTRO].dano[escolherDanoMonstro].nome}\x1b[0m e tirou \x1b[31m${monstroBATE}\x1b[0m`
      );
